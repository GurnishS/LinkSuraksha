...
const config = {
    ...
    BANK_URL: isCodespace ? replaceLocalhost(import.meta.env.VITE_BANK_FRONTEND_URL) : import.meta.env.VITE_BANK_FRONTEND_URL,
    GATEWAY_URL: isCodespace ? replaceLocalhost(import.meta.env.VITE_GATEWAY_FRONTEND_URL) : import.meta.env.VITE_GATEWAY_FRONTEND_URL,
    MERCHANT_URL: isCodespace ? replaceLocalhost(import.meta.env.VITE_MERCHANT_FRONTEND_URL) : import.meta.env.VITE_MERCHANT_FRONTEND_URL,
