...
import { addAccount,loginAccount ,getAccountById,transferFunds,fetchAccountTransactions,fetchTransactionDetailsById} from "../controllers/account.controller.js";
...
accountRouter.route("/transactions/:id").get(verifyJWT, fetchTransactionDetailsById);
